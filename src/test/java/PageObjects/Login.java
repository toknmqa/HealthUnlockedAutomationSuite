...
public class Login {
	...
	public void loginButton() {
		WebElement webElement = driver.findElement(By
				.cssSelector("a[data-reactid='.0.1.0.0.0']"));
	...
	/*
	 * public Boolean isNewsDropDownItemPresent(String newsItem){ WebElement
	 * webElement = driver.findElement(By.linkText(newsItem));
	 * 
	 * return webElement != null; }
	 */

	public Boolean verifyNewsDropDownItems(String newsItem) throws Throwable {
		WebElement webElement = WebPageHelpers
				.FindElementByCss("img[alt=\"News Section\"]");
		...
		WebElement element = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.className("daily_informer")));
		...
		try {
			...
			File scrFile = ((TakesScreenshot) driver)
					.getScreenshotAs(OutputType.FILE); // Can use BASE64 or
														// BYTES as OutputType
			FileUtils
					.copyFile(
							scrFile,
							new File(
									"C:\\Users\\Tim O'Keeffe\\Documents\\0001 Sunday Times top level navigation I should see a sub links "
											+ newsItem + ".jpg"));
